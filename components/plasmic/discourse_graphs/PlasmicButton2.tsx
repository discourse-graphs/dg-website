...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: 8dfh3YZZri3ew/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: a52ODPAyOhnTOA/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: F6DFxqqSKz3lTD/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__iruzk)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__plj86)}
                role={"img"}
              />
            ),
